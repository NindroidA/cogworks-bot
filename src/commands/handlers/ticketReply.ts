import { CacheType, ChatInputCommandInteraction, Client, TextChannel, MessageFlags } from 'discord.js';
...
export const ticketReplyHandler = async(client: Client, interaction: ChatInputCommandInteraction<CacheType>) => {
    try {
        ...
        await handleInteractionError(interaction, error, 'Failed to send ticket reply');
    }
};
