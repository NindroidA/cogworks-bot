...
const addStaff = new SlashCommandSubcommandBuilder()
    ...
    .addRoleOption((option) => option
        .setName('role_id')
        .setDescription(tlAdd.subcmdDescrp.roleid)
        .setRequired(true)
    )
    .addStringOption((option) => option
        .setName('alias')
        .setDescription(tlAdd.subcmdDescrp.alias)
        .setRequired(true)
    );
...
const removeStaff = new SlashCommandSubcommandBuilder()
    ...
    .addRoleOption((option) => option
        .setName('role_id')
        .setDescription(tlRemove.subcmdDescrp.roleid)
        .setRequired(true)
    );
...
const list = new SlashCommandSubcommandBuilder()
    .setName('list')
    .setDescription(tlGet.cmdDescrp);
