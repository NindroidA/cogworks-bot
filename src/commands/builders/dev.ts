...
export const dev = new SlashCommandBuilder()
  ...
  .addSubcommand(subcommand => subcommand.setName('bulk-close-tickets').setDescription(tl.bulkCloseTickets))
  .addSubcommand(subcommand =>
    subcommand
      .setName('delete-archived-ticket')
      .setDescription(tl.deleteArchivedTicket.descrp)
      .addUserOption(option => option.setName('user').setDescription(tl.deleteArchivedTicket.user).setRequired(true)),
  )
  .addSubcommand(subcommand =>
  ...
  .addSubcommand(subcommand =>
    subcommand.setName('delete-all-archived-applications').setDescription(tl.deleteAllArchivedApplications),
  );
