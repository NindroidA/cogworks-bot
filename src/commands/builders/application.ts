...
const positionAdd = new SlashCommandSubcommandBuilder()
  ...
  .addStringOption(option =>
    option
      ...
      .addChoices({ name: 'Set Builder', value: 'set_builder' }),
  )
...
const positionRemove = new SlashCommandSubcommandBuilder()
  ...
  .addIntegerOption(option =>
    option.setName('id').setDescription(tSC['remove-id']).setRequired(true),
  );
...
const positionToggle = new SlashCommandSubcommandBuilder()
  ...
  .addIntegerOption(option =>
    option.setName('id').setDescription(tSC['toggle-id']).setRequired(true),
  );
