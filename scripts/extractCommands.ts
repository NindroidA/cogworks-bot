...
function extractCommands(): Command[] {
  ...
  if (memory.builder) {
    const subcommands: Subcommand[] = [
      {
        name: "setup",
        description: "Set up the memory system",
        usage: "/memory setup [channel]",
      },
      {
        name: "add",
      ...
      {
        name: "capture",
        description: "Capture a message as memory item",
        usage: "/memory capture <message_link>",
      },
      {
        name: "tags",
        description: "Manage memory tags",
        usage: "/memory tags <action>",
      },
    ];
    ...
    commands.push({
      name: "memory",
      description:
        memory.builder?.cmdDescrp ||
        "Manage memory system for tracking bugs, features, and notes",
  ...
  if (botSetup.builder) {
    commands.push({
      name: "bot-setup",
      description:
        botSetup.builder?.cmdDescrp ||
        "Configure Cogworks for your server with an interactive setup wizard.",
      usage: "/bot-setup",
      category: "Setup",
      permissions: ["Administrator"],
      examples: ["/bot-setup"],
  ...
  if (ticket.setup) {
    commands.push({
      name: "ticket-setup",
      description:
        ticket.setup?.builder?.cmdDescrp ||
  ...
  if (ticket.customTypes) {
    ...
    if (ct.typeAdd)
      subcommands.push({
        name: "type-add",
        description: ct.typeAdd.cmdDescrp || "Add a custom ticket type",
        usage: "/ticket type-add",
      });
    if (ct.typeEdit)
      subcommands.push({
        name: "type-edit",
        description: ct.typeEdit.cmdDescrp || "Edit a ticket type",
        usage: "/ticket type-edit <type>",
      });
    if (ct.typeList)
      subcommands.push({
        name: "type-list",
        description: ct.typeList?.cmdDescrp || "List all ticket types",
        usage: "/ticket type-list",
      });
    if (ct.typeToggle)
      subcommands.push({
        name: "type-toggle",
        description: ct.typeToggle?.cmdDescrp || "Toggle a ticket type",
        usage: "/ticket type-toggle <type>",
      });
    if (ct.typeDefault)
      subcommands.push({
        name: "type-default",
        description: ct.typeDefault?.cmdDescrp || "Set default ticket type",
        usage: "/ticket type-default <type>",
      });
    if (ct.typeRemove)
      subcommands.push({
        name: "type-remove",
        description: ct.typeRemove?.cmdDescrp || "Remove a ticket type",
        usage: "/ticket type-remove <type>",
      });
  ...
  if (application.setup) {
    commands.push({
      ...
      description:
        application.setup?.builder?.cmdDescrp ||
  ...
  if (application.position) {
    const subcommands: Subcommand[] = [
      {
        name: "position add",
        description: "Add a new application position",
        usage: "/application position add",
      },
      {
        name: "position remove",
        description: "Remove an application position",
        usage: "/application position remove <id>",
      },
      {
        name: "position toggle",
        description: "Toggle position availability",
        usage: "/application position toggle <id>",
      },
      {
        name: "position list",
        description: "List all positions",
        usage: "/application position list",
      },
      {
        name: "position refresh",
        description: "Refresh position message",
        usage: "/application position refresh",
      },
    ];
  ...
  if (announcement.setup) {
    commands.push({
      ...
      description:
        announcement.setup?.builder?.cmdDescrp ||
        "Set up the announcement system.",
  ...
  if (announcement.builder) {
    const subcommands: Subcommand[] = [
      {
        name: "maintenance",
        description: "Send a maintenance announcement",
        usage: "/announcement maintenance",
      },
      {
        name: "maintenance-scheduled",
        description: "Schedule maintenance announcement",
        usage: "/announcement maintenance-scheduled <time>",
      },
      {
        name: "back-online",
        description: "Send back online announcement",
        usage: "/announcement back-online",
      },
      {
        name: "update-scheduled",
        description: "Schedule update announcement",
        usage: "/announcement update-scheduled <time>",
      },
      {
        name: "update-complete",
        description: "Send update complete announcement",
        usage: "/announcement update-complete",
      },
    ];
    ...
    commands.push({
      name: "announcement",
      description:
        announcement.builder?.cmdDescrp ||
        "Send various types of announcements.",
  ...
  if (baitChannel.builder) {
    const subcommands: Subcommand[] = [
      {
        name: "setup",
        description: "Set up bait channel detection",
        usage: "/baitchannel setup",
      },
      {
        name: "detection",
        description: "Configure detection settings",
        usage: "/baitchannel detection",
      },
      {
        name: "whitelist",
        description: "Manage whitelist",
        usage: "/baitchannel whitelist <add|remove>",
      },
      {
        name: "status",
        description: "View bait channel status",
        usage: "/baitchannel status",
      },
      {
        name: "stats",
        description: "View detection statistics",
        usage: "/baitchannel stats",
      },
      {
        name: "toggle",
        description: "Enable/disable bait channel",
        usage: "/baitchannel toggle",
      },
    ];
    ...
    commands.push({
      name: "baitchannel",
      description:
        baitChannel.builder?.cmdDescrp ||
        "Configure bait channel honeypot system.",
    ...
    const subcommands: Subcommand[] = [
      {
        ...
        usage: "/role add staff <role> <alias>",
      },
      {
        name: "add admin",
        description: "Add an admin role",
        usage: "/role add admin <role> <alias>",
      },
      {
        name: "remove staff",
        description: "Remove a staff role",
        usage: "/role remove staff <alias>",
      },
      {
        name: "remove admin",
        description: "Remove an admin role",
        usage: "/role remove admin <alias>",
      },
      {
        name: "list",
        description: "View configured staff and admin roles",
        usage: "/role list",
      },
    ];
  ...
  if (dev.builder) {
    const subcommands: Subcommand[] = [
      {
        ...
        description: "Close all active tickets",
        usage: "/dev bulk-close-tickets",
      },
      {
        name: "delete-archived-ticket",
        description: "Delete archived ticket",
        usage: "/dev delete-archived-ticket <user>",
      },
      {
        name: "delete-all-archived-tickets",
        description: "Delete all archived tickets",
        usage: "/dev delete-all-archived-tickets",
      },
      {
        name: "delete-archived-application",
        description: "Delete archived application",
        usage: "/dev delete-archived-application <user>",
      },
      {
        name: "delete-all-archived-applications",
        description: "Delete all archived applications",
        usage: "/dev delete-all-archived-applications",
      },
    ];
    ...
    commands.push({
      name: "dev",
      description:
        dev.builder?.cmdDescrp ||
        "Development and maintenance commands (admin only).",
  ...
  commands.push({
    ...
    subcommands: [
      {
        name: "ticket-tags",
        description: "Migrate ticket tags to new format",
        usage: "/migrate ticket-tags",
      },
      {
        name: "application-tags",
        description: "Migrate application tags",
        usage: "/migrate application-tags",
      },
    ],
  });
